...
This matrix2669-owned report was imported into `ffmpeg-adaptive` as historical
validation evidence for the exact independently structured runtime from which
the standalone project was initialized. References to “baseline,” “rewrite,”
and the prior branch describe the controlled comparison environment; they do
not import that repository's Git history into this project.
